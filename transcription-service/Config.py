...
def load_settings() -> Settings:
    ...
    settings: Settings = {
        ...
        'VAD_DEVICE': get_variable('TRANSCRIPTION_VAD_DEVICE', "cpu"), # type: ignore
        ...
        'FASTER_WHISPER_COMPUTE_TYPE': get_variable('TRANSCRIPTION_FASTER_WHISPER_COMPUTE_TYPE', "int8"), # type: ignore
